...
import User from "../models/user.model.js"; // LinkUps user model

// Helper: Get user from token (LinkUps Auth)
...
// This implements your "uploadResume" logic to create a resume from raw text
